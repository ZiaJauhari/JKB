...
CREATE TABLE IF NOT EXISTS inquiries (
    ...
    product_type VARCHAR(255) NOT NULL, -- Keep for backward compatibility
    product_id INT NULL, -- New foreign key to products
    message TEXT,
...
CREATE TABLE IF NOT EXISTS articles (
    ...
    author VARCHAR(100) DEFAULT 'Admin', -- Keep for backward compatibility
    author_id INT NULL, -- New foreign key to admin_users
    image_url VARCHAR(500),
...
UPDATE articles SET author_id = (
    ...
    WHERE a.full_name = articles.author OR a.username = articles.author
    LIMIT 1
