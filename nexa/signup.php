    ...
    if (empty($username) || empty($password) || empty($confirm_password) || empty($full_name) || empty($email)) {
        ...
        try {
            ...
            if ($stmt->fetch()) {
                ...
                if ($stmt->execute(array($username, $hashed_password, $full_name, $email))) {
