...
// Recent subscribers
$stmt = $db->query("SELECT * FROM newsletter_subscribers ORDER BY subscribed_at DESC LIMIT 5");
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-lg-2 px-0 sidebar">
                <div class="p-3">
                    <h4 class="text-center mb-4">
                        <i class="fas fa-globe-asia me-2"></i>GEI Admin
                    </h4>
                    
                    <div class="text-center mb-4">
                        <img src="https://ui-avatars.com/api/?name=<?php echo urlencode($_SESSION['admin_name']); ?>&background=fff&color=0d6efd" 
                             alt="Admin" class="rounded-circle mb-2" width="80">
                        <h6 class="mb-0"><?php echo htmlspecialchars($_SESSION['admin_name']); ?></h6>
                        <small class="text-white-50"><?php echo ucfirst($_SESSION['admin_role']); ?></small>
                    </div>
            ...
            <div class="col-md-9 col-lg-10 px-4 py-4">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h2>Dashboard</h2>
                        <p class="text-muted mb-0">Selamat datang kembali, <?php echo htmlspecialchars($_SESSION['admin_name']); ?>!</p>
                    </div>
                    <div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="card">
                            <div class="card-header bg-white">
                                <h5 class="mb-0">
                                    <i class="fas fa-users me-2"></i>Subscriber Terbaru
                                </h5>
                            </div>
                            <div class="card-body p-0">
                                <div class="table-responsive">
